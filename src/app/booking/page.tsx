  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
      ...
      <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14 space-y-3">
        ...
        <h1 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-bold text-silver-900">
          Formulir Booking Dekorasi
        </h1>
        <p className="text-xs sm:text-sm text-silver-600 max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="luxury-card p-6 sm:p-8 space-y-6">
              <div className="flex items-center gap-2.5 pb-4 border-b border-silver-200">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div className="space-y-1.5 sm:col-span-2">
                  <label className="text-xs font-semibold text-silver-800 flex items-center gap-1">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 text-sm bg-white border border-silver-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold focus:border-gold transition-all"
                  />
                  {errors.bride_names && (
                    <p className="text-xs text-red-500">{errors.bride_names.message}</p>
                  )}
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 text-sm bg-white border border-silver-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold focus:border-gold transition-all uppercase"
                  />
                  {errors.initials && (
                    <p className="text-xs text-red-500">{errors.initials.message}</p>
                  )}
                  <p className="text-[11px] text-silver-500">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div className="space-y-1.5">
                  ...
                  >
                    ...
                    <option value="Corporate">Acara Perusahaan (Corporate)</option>
                ...
                <div className="space-y-1.5 sm:col-span-2">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 text-sm bg-white border border-silver-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold focus:border-gold transition-all disabled:bg-silver-100"
                  >
                  ...
                  {errors.package_type && (
                    <p className="text-xs text-red-500">{errors.package_type.message}</p>
                  )}
                </div>

                {/* Dekor Akad: Dalam / Luar */}
                <div className="space-y-2 sm:col-span-2">
                  <label className="text-xs font-semibold text-silver-800 block">
                    Penempatan Dekorasi Akad / Ijab
                  </label>
                  <div className="grid grid-cols-2 gap-4">
                    <label className="flex items-center gap-3 p-3.5 border border-silver-200 rounded-xl cursor-pointer hover:bg-silver-50 has-[:checked]:border-gold has-[:checked]:bg-gold/5 transition-all">
                      <input
                        type="radio"
                        value="Dalam"
                      ...
                      />
                      <div>
                        <span className="text-xs font-bold text-silver-900 block">
                          Dekor Akad Dalam
                        </span>
                  ...
                  {errors.decoration_type && (
                    <p className="text-xs text-red-500">{errors.decoration_type.message}</p>
                  )}
                </div>
                ...
                <div className="space-y-1.5 sm:col-span-2">
                  ...
                  <div className="relative">
                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-xs font-bold text-silver-500">
                      Rp
                    </span>
                    <input
                      type="number"
                      ...
                      min="500000"
                      {...register('dp_amount')}
                      className="w-full pl-12 pr-4 py-3 text-sm bg-white border border-silver-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold focus:border-gold transition-all font-semibold"
                    />
                  </div>
                  {errors.dp_amount && (
                    <p className="text-xs text-red-500">{errors.dp_amount.message}</p>
                  )}
                  <p className="text-[11px] text-silver-500">
            ...
            <div className="luxury-card p-6 sm:p-8 space-y-6">
              ...
              <div className="space-y-1.5 pt-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 text-sm bg-white border border-silver-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold focus:border-gold transition-all resize-none"
                />
                {errors.address && (
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-28 space-y-6">
            <div className="luxury-card p-6 border-gold/30 bg-gradient-to-b from-white to-champagne/20 space-y-5">
              <div className="flex items-center justify-between pb-3 border-b border-silver-200">
              ...
              <div className="space-y-3 text-xs">
                <div className="flex justify-between py-1 border-b border-silver-100">
                  <span className="text-silver-500">Pilihan Paket:</span>
                  <span className="font-bold text-silver-900">
                    {selectedPackageName || '-'}
                  </span>
                </div>

                <div className="flex justify-between py-1 border-b border-silver-100">
                  <span className="text-silver-500">Tanggal Acara:</span>
                ...
                <div className="flex justify-between py-1 border-b border-silver-100">
                  <span className="text-silver-500">Penempatan Akad:</span>
                  <span className="font-medium text-silver-900">
                ...
                <div className="pt-2 flex justify-between items-baseline">
                  <span className="font-semibold text-silver-800">DP Minimal:</span>
              ...
              {/* Info Box */}
              <div className="p-3.5 rounded-xl bg-white/80 border border-silver-200 text-xs text-silver-600 space-y-2">
